...
{
	Set_7017_AiType(ID, AiType_5V);delay_ms(100);
	Set_7017_AiEnable(ID, AiChannel_ALL);delay_ms(100);
	Set_7017_AiDataType(ID, ANALOG_VALUE);delay_ms(100);
	Set_7017_AiNumberOfFilters(ID, AiNumOfFilters(5));delay_ms(100);
	lapsetime_TPDO(ID, _TPDO1, 999);delay_ms(100);
	lapsetime_TPDO(ID, _TPDO2, 999);delay_ms(100);
	event_TPDO(ID, _TPDO1, 100);delay_ms(100);
	event_TPDO(ID, _TPDO2, 100);delay_ms(100);
}
