...
{
	Set_5801_Frequency_Type(address, value);//0xFF所有通道设为测频率模式
	Set_5801_Filter_Time(address, Passageway_CF0, Filtertime_10);//设置通道0 1滤波时间
	Set_5801_Filter_Time(address, Passageway_CF1, Filtertime_10);//设置通道0 1滤波时间
	Set_5801_Filter_Time(address, Passageway_CF2, Filtertime_10);//设置通道0 1滤波时间
	Set_5801_Filter_Time(address, Passageway_CF3, Filtertime_10);//设置通道0 1滤波时间
	Set_5801_Filter_Time(address, Passageway_CF4, Filtertime_10);//设置通道0 1滤波时间
	Set_5801_Filter_Time(address, Passageway_CF5, Filtertime_10);//设置通道0 1滤波时间
	Set_5801_Filter_Time(address, Passageway_CF6, Filtertime_10);//设置通道0 1滤波时间
	Set_5801_Filter_Time(address, Passageway_CF7, Filtertime_10);//设置通道0 1滤波时间
	Set_5801_Excessive_Time(address, Passageway_CF0, 0x32);
	Set_5801_Excessive_Time(address, Passageway_CF1, 0x32);
	Set_5801_Excessive_Time(address, Passageway_CF2, 0x32);
	Set_5801_Excessive_Time(address, Passageway_CF3, 0x32);
	Set_5801_Excessive_Time(address, Passageway_CF4, 0x32);
	Set_5801_Excessive_Time(address, Passageway_CF5, 0x32);
	Set_5801_Excessive_Time(address, Passageway_CF6, 0x32);
	Set_5801_Excessive_Time(address, Passageway_CF7, 0x32);
	...
	event_TPDO(address, _TPDO1, 10);delay_ms(100);
	event_TPDO(address, _TPDO2, 10);delay_ms(100);
	event_TPDO(address, _TPDO3, 10);delay_ms(100);
	event_TPDO(address, _TPDO4, 10);delay_ms(100);
}

u8 rec_5801_ImpulseValue(uint32_t ID, u32 resut_int[8])//读取频率值
{
	u8 buf[8];
	CanRxMsg RxMessage;
